...
for i=1:12
    ...
    FallName = {'flat_sphere1';'flat_sphere1_soft';'flat_sphere2';'flat_sphere2_soft';'slope21_sphere1';'slope21_sphere1_soft';'slope21_sphere2';  'slope21_sphere2_soft';'slope33_sphere1';'slope33_sphere1_so';...
        'ft';'slope33_sphere2';'slope33_sphere2_soft'};
    title(FallName{i});
    xlabel('x[px]')
    ylabel('z[px]')
